...
public class MoveToEnemyBase extends ActionNode {
    ...
    public void exec(GPTurnContext ctx) {
        ...
        if (enemyBase != null) ctx.ai.move(u, enemyBase.getX(), enemyBase.getY());
        else ctx.ai.idle(u);
    }
    ...
    @Override
    public ActionNode copy() { return new MoveToEnemyBase(); }
}
