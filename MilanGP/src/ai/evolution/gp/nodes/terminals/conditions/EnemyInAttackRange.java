...
public class EnemyInAttackRange extends BoolNode {
    ...
    public boolean eval(GPTurnContext ctx) {
        ...
        return GPUtil.manhattan(u.getX(), u.getY(), enemy.getX(), enemy.getY()) <= u.getType().attackRange;
    }
    ...
    @Override
    public BoolNode copy() { return new EnemyInAttackRange(); }
}
