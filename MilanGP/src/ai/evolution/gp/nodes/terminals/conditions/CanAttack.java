...
public class CanAttack extends BoolNode {
    public static final String NAME = "CanAttack";

    @Override
    public boolean eval(GPTurnContext ctx) { return ctx.unit.getType().canAttack; }
    ...
    @Override
    public BoolNode copy() { return new CanAttack(); }
}
